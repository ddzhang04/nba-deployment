...
const LAST_ALL_STAR_BEFORE_1986_KEYS = new Set([
  ...
  'Lionel Hollins', 'Truck Robinson', 'Calvin Murphy', 'Billy Knight', 'Bobby Jones',
  ...
  'Ralph Beard', 'John Block', 'Don Barksdale', 'Dick Barnett', 'Alvan Adams', 'Bob Boozer', 'Bill Bradley',
